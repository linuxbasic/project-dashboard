...
class PhaseCostTests(TestCase):
    ...
    def test_should_return_predicted_cost_on_specific_date(self):
        ...
        self.assertEqual(phase.get_cost(START_DATE + timedelta(days=1)), PREDICTED_DURATION_1 * RESOURCE_COST)
        self.assertEqual(phase.get_cost(START_DATE + timedelta(days=2)), PREDICTED_DURATION_1 * RESOURCE_COST)
        self.assertEqual(phase.get_cost(START_DATE + timedelta(days=3)), PREDICTED_DURATION_2 * RESOURCE_COST)
        self.assertEqual(phase.get_cost(START_DATE + timedelta(days=4)), PREDICTED_DURATION_2 * RESOURCE_COST)
