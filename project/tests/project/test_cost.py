...
class ProjectCostTests(TestCase):
    ...
    def test_should_return_correct_cost_on_specific_date(self):
        ...
        self.assertEqual(project.get_cost(START_DATE_PLUS_1), PLANNED_COST * (1 / 3))
        self.assertEqual(project.get_cost(START_DATE_PLUS_2), PLANNED_COST * (2 / 3))
        ...
        self.assertEqual(project.get_planned_cost(START_DATE_PLUS_1), PLANNED_COST * (1 / 3))
        self.assertEqual(project.get_planned_cost(START_DATE_PLUS_2), PLANNED_COST * (2 / 3))
        self.assertEqual(project.get_planned_cost(START_DATE_PLUS_3), PLANNED_COST)
        self.assertEqual(project.get_planned_cost(START_DATE_PLUS_4), PLANNED_COST)
    ...
    def test_should_return_correct_cost_on_specific_date_with_predictions(self):
        ...
        self.assertEqual(project.get_cost(START_DATE), 0)
        self.assertEqual(project.get_cost(start_date_plus(1)), 1 * COST_TASK_1 + 0 * COST_TASK_2)
        self.assertEqual(project.get_cost(start_date_plus(2)), 2 * COST_TASK_1 + 0 * COST_TASK_2)
        self.assertEqual(project.get_cost(start_date_plus(3)), 3 * COST_TASK_1 + 0 * COST_TASK_2)
        self.assertEqual(project.get_cost(start_date_plus(4)), 3 * COST_TASK_1 + 1 * COST_TASK_2)
        self.assertEqual(project.get_cost(start_date_plus(5)), 3 * COST_TASK_1 + 2 * COST_TASK_2)
        self.assertEqual(project.get_cost(start_date_plus(6)), 3 * COST_TASK_1 + 2 * COST_TASK_2)

        self.assertEqual(project.get_planned_cost(START_DATE), 0)
        self.assertEqual(project.get_planned_cost(start_date_plus(1)), 1 * COST_TASK_1 + 0 * COST_TASK_2)
        self.assertEqual(project.get_planned_cost(start_date_plus(2)), 2 * COST_TASK_1 + 0 * COST_TASK_2)
        self.assertEqual(project.get_planned_cost(start_date_plus(3)), 3 * COST_TASK_1 + 0 * COST_TASK_2)
        self.assertEqual(project.get_planned_cost(start_date_plus(4)), 4 * COST_TASK_1 + 0 * COST_TASK_2)
        self.assertEqual(project.get_planned_cost(start_date_plus(5)), 4 * COST_TASK_1 + 1 * COST_TASK_2)
        self.assertEqual(project.get_planned_cost(start_date_plus(6)), 4 * COST_TASK_1 + 2 * COST_TASK_2)
        self.assertEqual(project.get_planned_cost(start_date_plus(7)), 4 * COST_TASK_1 + 3 * COST_TASK_2)
        self.assertEqual(project.get_planned_cost(start_date_plus(8)), 4 * COST_TASK_1 + 4 * COST_TASK_2)
        self.assertEqual(project.get_planned_cost(start_date_plus(9)), 4 * COST_TASK_1 + 4 * COST_TASK_2)
